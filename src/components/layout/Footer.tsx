      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-white">DoneDep</span>
            </Link>
            <p className="text-sm leading-6 text-gray-300">
              The autonomous deployment platform that simplifies your entire infrastructure stack. 
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-sm text-gray-300">
                Get the latest news and updates about DoneDep features.
              </p>
            </div>
            <div className="flex max-w-md">
              ...
              <button
                type="submit"
                className="flex-none rounded-md bg-primary-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 ml-4"
              >
                Subscribe
              </button>
            </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            ...
            <Link href="/cookies" className="text-xs text-gray-400 hover:text-gray-300">
              Cookie Policy
            </Link>
          </div>
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; 2024 DoneDep, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
